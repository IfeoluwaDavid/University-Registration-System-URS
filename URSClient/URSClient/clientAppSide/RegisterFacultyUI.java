...
public class RegisterFacultyUI extends javax.swing.JDialog
/****************************************************************************************/
{
    public RegisterFacultyUI() {
        initComponents();
    }
...
/****************************************************************************************/
    private void initComponents() {
    	...
    	String requestingUI = "facultyOptionsForRegisterFaculty";
        ...
        jLabel1.setText("Register New Faculty");
...
/****************************************************************************************/
        ...
        jButton1.addActionListener(new java.awt.event.ActionListener()
        {
            ...
            {
            	String operationName = "createFaculty";
                ...
                String faculty = String.valueOf(jComboBox9.getSelectedItem());
...
/****************************************************************************************/
    public static void facultyOptionsForRegisterFaculty(ArrayList<String> facultyList)
    {
    	...
    	jComboBox9.setModel(new javax.swing.DefaultComboBoxModel<>(programArray));
    }
    ...
    public static void display() {
        ...
        catch (ClassNotFoundException ex) {java.util.logging.Logger.getLogger(RegisterFacultyUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);}
        catch (InstantiationException ex) {java.util.logging.Logger.getLogger(RegisterFacultyUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);}
        catch (IllegalAccessException ex) {java.util.logging.Logger.getLogger(RegisterFacultyUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);}
        catch (javax.swing.UnsupportedLookAndFeelException ex) {java.util.logging.Logger.getLogger(RegisterFacultyUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex); }

/****************************************************************************************/        
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RegisterFacultyUI().setVisible(true);
            }
        });
    }
/****************************************************************************************/
    ...
    private static javax.swing.JComboBox<String> jComboBox9;
