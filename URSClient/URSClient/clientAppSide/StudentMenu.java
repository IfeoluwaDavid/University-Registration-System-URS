...
public class StudentMenu extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Student Logged In: John Baker");
        ...
        jButton3.setText("Registered Courses");
        jButton4.setText("Search Courses");

        jList1.setModel(new javax.swing.AbstractListModel<String>() {
            String[] strings = { "Software Engineering", "Chemical Engineering", "Electrical Science", "Software Science", "Mechanical Science" };
    ...
    public void display() {
        try {
        	...
        	catch (InstantiationException ex) {java.util.logging.Logger.getLogger(StudentMenu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);}
        	catch (IllegalAccessException ex) {java.util.logging.Logger.getLogger(StudentMenu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);}
